...
$id = $_GET["id"];
$alumnos = new consultas();
$sentencia = $alumnos->mostrar_update($id);
...
<body>
    ...
    <form method="post" action="nuevoAlumno.php" class="was-validated">
        ...
        <?php
        $id = $_GET['id'];
$resultado = $BaseDatos->actulizarAlumno($nombre, $ape1, $ape2, $contra, $dni, $fecha, $correo, $tel, $empresa, $tutor, $ndual, $nfct,$obs);
